...
\begin{document}
	...
	\section{Premesse teoriche}
		...
		\subsection{Rivelatore di picco}
			Il rivelatore di picco è un circuito costituito da un diodo in serie con un condensatore, quando lo si alimenta il condensatore inizia a caricarsi, raggiungendo il valore di picco del segnale in ingresso.
