			...
			\subsubsection{Diodo}
				...
				\begin{center}
					\begin{tabular}{ |c|c|c| }
						...
						\multirow{$ 0.2 $}										 & $ 2.07 \, \mathrm{mV} $     & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 0.4 $}										 & $ 45.31 \, \mathrm{mV} $    & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 0.6 $}										 & $ 177 \, \mathrm{mV} $      & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 0.8 $}										 & $ 344 \, \mathrm{mV} $      & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 1 $}										 & $ 526 \, \mathrm{mV} $      & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 1.5 $}										 & $ 997 \, \mathrm{mV} $      & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 2 $}										 & $ 1.48 \, \mathrm{V} $      & $ 0 \, \mathrm{mA} $ \\
						\hline
					\end{tabular}
				\end{center}
...
%					\begin{subfigure}{0.4\textwidth}
%						\centering
%						\includegraphics[scale=0.5]{caratteristicheStaticheDiodoCaratteristica}
			...
			\subsubsection{Diodo di Zener}
				...
				\begin{center}
					\begin{tabular}{ |c|c|c| }
						...
						\multirow{\textbf{$ V_{\mathrm{e}} $ [$ \mathrm{V} $]}}	 & \textbf{$ V_{\mathrm{u}} $} & \textbf{$ I_{\mathrm{D}} $} \\
						\hline
						\multirow{$ -4 $}										 & $ -3.31 \, \mathrm{mV} $   & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ -3.5 $}										 & $ -2.81 \, \mathrm{mV} $   & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ -3 $}										 & $ -2.32 \, \mathrm{mV} $   & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ -2 $}										 & $ -1.33 \, \mathrm{mV} $   & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ -1 $}										 & $ -0.37 \, \mathrm{mV} $   & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 0 $}										 & $ 0.006 \, \mathrm{mV} $	  & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 0.2 $}										 & $ 0.019 \, \mathrm{mV} $   & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 0.4 $}										 & $ 0.966 \, \mathrm{mV} $   & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 0.6 $}										 & $ 43.5 \, \mathrm{mV} $    & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 0.8 $}										 & $ 191 \, \mathrm{mV} $     & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 1 $}										 & $ 373 \, \mathrm{mV} $     & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 1.5 $}										 & $ 847 \, \mathrm{mV} $     & $ 0 \, \mathrm{mA} $ \\
						\multirow{$ 2 $}										 & $ 1.33 \, \mathrm{V} $     & $ 0 \, \mathrm{mA} $ \\
						\hline
					\end{tabular}
				\end{center}
...
%					\begin{subfigure}{0.4\textwidth}
%						\centering
%						\includegraphics[scale=0.5]{caratteristicheStaticheDiodoDiZenerCaratteristica}
			...
			\subsubsection{Diodo}
				...
				\begin{center}
					\begin{tabular}{ |c|c|c| }
						...
						\hline
						\multirow{$ 4.48 \, \mathrm{V} $} & $ 2.56 \, \mathrm{V} $ & $ 480 \, \mathrm{mV} $ \\
						\hline
					\end{tabular}
				\end{center}
				\begin{figure}[h!]
			...
			\subsubsection{Diodo di Zener}	
				...
				\begin{center}
					\begin{tabular}{ |c|c|c| }
						...
						\multirow{\textbf{$ C_{1} $}} & \textbf{$ C_{2} $} & \textbf{$ C_{3} $} \\
						\hline
						\multirow{$ 7.20 \, \mathrm{V} $} & $ 6.88 \, \mathrm{V} $ & $ 5.52 \, \mathrm{V} $ \\
						\hline
					\end{tabular}
				\end{center}
				\begin{figure}[h!]
